...
if not tickers:
    ...
    for ticker in tickers:
        ...
        if df is not None:
            ...
            st.divider()
            st.subheader(f"📊 {f_info['name']} ({ticker})")

            col1, col2, col3, col4, col5 = st.columns(5)
            # 強制使用 inverse 達到 紅漲綠跌
            ...
            # 使用 Markdown 語法強制改變變動率數字顏色
            st.markdown(f"""
                            <div style="font-size:1.1em; font-weight:bold;">
                                📈 AI 預估未來 <span style="color:blue;">{predict_days}</span> 天變動率：
                                <span style="color:{trend_html_color}; font-size:1.2em;">
            ...
            t1, t2, t3 = st.tabs(["📈 趨勢布林", "📊 MACD 動能", "🔮 AI 預測"])
